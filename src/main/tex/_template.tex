...
\hypersetup{pdfinfo={
	Title={--},  % unrelated to the title on the first-page; title of the morsel
	...
	CreatedOn={--}, % custom metadata-entry; format: Month Day, Year
	LastUpdatedOn={\today}, % custom metadata-entry
	Keywords={--} % separated by " | ", i.e. pipe symbol
}}
